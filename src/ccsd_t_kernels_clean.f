...
c
     ...
     1   + t1sub(p4,h1)*v2sub(h3,h2,p6,p5)
      ...
      subroutine clean_sd_t_s1_2(h3d,h2d,h1d,p6d,p5d,p4d,
     2                     triplesx,t1sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d
      integer h3,h2,h1,p6,p5,p4
     ...
     1   - t1sub(p4,h1)*v2sub(h3,h2,p6,p5)
      ...
      subroutine clean_sd_t_s1_3(h3d,h2d,h1d,p6d,p5d,p4d,
     2                     triplesx,t1sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d
      integer h3,h2,h1,p6,p5,p4
     ...
     1   + t1sub(p4,h1)*v2sub(h3,h2,p6,p5)
      ...
      subroutine clean_sd_t_s1_4(h3d,h2d,h1d,p6d,p5d,p4d,
     2                     triplesx,t1sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d
      integer h3,h2,h1,p6,p5,p4
     ...
     1   - t1sub(p4,h1)*v2sub(h3,h2,p6,p5)
      ...
      subroutine clean_sd_t_s1_5(h3d,h2d,h1d,p6d,p5d,p4d,
     2                     triplesx,t1sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d
      integer h3,h2,h1,p6,p5,p4
     ...
     1   + t1sub(p4,h1)*v2sub(h3,h2,p6,p5)
      ...
      subroutine clean_sd_t_s1_6(h3d,h2d,h1d,p6d,p5d,p4d,
     2                     triplesx,t1sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d
      integer h3,h2,h1,p6,p5,p4
     ...
     1   - t1sub(p4,h1)*v2sub(h3,h2,p6,p5)
      ...
      subroutine clean_sd_t_s1_7(h3d,h2d,h1d,p6d,p5d,p4d,
     2                     triplesx,t1sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d
      integer h3,h2,h1,p6,p5,p4
     ...
     1   + t1sub(p4,h1)*v2sub(h3,h2,p6,p5)
      ...
      subroutine clean_sd_t_s1_8(h3d,h2d,h1d,p6d,p5d,p4d,
     2                     triplesx,t1sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d
      integer h3,h2,h1,p6,p5,p4
     ...
     1   - t1sub(p4,h1)*v2sub(h3,h2,p6,p5)
      ...
      subroutine clean_sd_t_s1_9(h3d,h2d,h1d,p6d,p5d,p4d,
     2                     triplesx,t1sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d
      integer h3,h2,h1,p6,p5,p4
     ...
     1   + t1sub(p4,h1)*v2sub(h3,h2,p6,p5)
      ...
      subroutine clean_sd_t_d1_1(h3d,h2d,h1d,p6d,p5d,p4d,h7d,
     ...
     1  -t2sub(h7,p4,p5,h1)*v2sub(h3,h2,p6,h7)
      ...
      subroutine clean_sd_t_d1_2(h3d,h2d,h1d,p6d,p5d,p4d,h7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,h7d
      integer h3,h2,h1,p6,p5,p4,h7
     ...
     1   + t2sub(h7,p4,p5,h1)*v2sub(h3,h2,p6,h7)
      ...
      subroutine clean_sd_t_d1_3(h3d,h2d,h1d,p6d,p5d,p4d,h7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,h7d
      integer h3,h2,h1,p6,p5,p4,h7
     ...
     1  -t2sub(h7,p4,p5,h1)*v2sub(h3,h2,p6,h7)
      ...
      subroutine clean_sd_t_d1_4(h3d,h2d,h1d,p6d,p5d,p4d,h7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,h7d
      integer h3,h2,h1,p6,p5,p4,h7
     ...
     1  -t2sub(h7,p4,p5,h1)*v2sub(h3,h2,p6,h7)
      ...
      subroutine clean_sd_t_d1_5(h3d,h2d,h1d,p6d,p5d,p4d,h7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,h7d
      integer h3,h2,h1,p6,p5,p4,h7
     ...
     1   + t2sub(h7,p4,p5,h1)*v2sub(h3,h2,p6,h7)
      ...
      subroutine clean_sd_t_d1_6(h3d,h2d,h1d,p6d,p5d,p4d,h7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,h7d
      integer h3,h2,h1,p6,p5,p4,h7
     ...
     1  -t2sub(h7,p4,p5,h1)*v2sub(h3,h2,p6,h7)
      ...
      subroutine clean_sd_t_d1_7(h3d,h2d,h1d,p6d,p5d,p4d,h7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,h7d
      integer h3,h2,h1,p6,p5,p4,h7
     ...
     1   + t2sub(h7,p4,p5,h1)*v2sub(h3,h2,p6,h7)
      ...
      subroutine clean_sd_t_d1_8(h3d,h2d,h1d,p6d,p5d,p4d,h7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,h7d
      integer h3,h2,h1,p6,p5,p4,h7
     ...
     1  -t2sub(h7,p4,p5,h1)*v2sub(h3,h2,p6,h7)
      ...
      subroutine clean_sd_t_d1_9(h3d,h2d,h1d,p6d,p5d,p4d,h7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,h7d
      integer h3,h2,h1,p6,p5,p4,h7
     ...
     1   + t2sub(h7,p4,p5,h1)*v2sub(h3,h2,p6,h7)
      ...
      subroutine clean_sd_t_d2_1(h3d,h2d,h1d,p6d,p5d,p4d,p7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
     ...
     1  -t2sub(p7,p4,h1,h2)*v2sub(p7,h3,p6,p5)
      ...
      subroutine clean_sd_t_d2_2(h3d,h2d,h1d,p6d,p5d,p4d,p7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,p7d
      integer h3,h2,h1,p6,p5,p4,p7
     ...
     1  -t2sub(p7,p4,h1,h2)*v2sub(p7,h3,p6,p5)
      ...
      subroutine clean_sd_t_d2_3(h3d,h2d,h1d,p6d,p5d,p4d,p7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,p7d
      integer h3,h2,h1,p6,p5,p4,p7
     ...
     1   + t2sub(p7,p4,h1,h2)*v2sub(p7,h3,p6,p5)
      ...
      subroutine clean_sd_t_d2_4(h3d,h2d,h1d,p6d,p5d,p4d,p7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,p7d
      integer h3,h2,h1,p6,p5,p4,p7
     ...
     1   + t2sub(p7,p4,h1,h2)*v2sub(p7,h3,p6,p5)
      ...
      subroutine clean_sd_t_d2_5(h3d,h2d,h1d,p6d,p5d,p4d,p7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,p7d
      integer h3,h2,h1,p6,p5,p4,p7
     ...
     1   + t2sub(p7,p4,h1,h2)*v2sub(p7,h3,p6,p5)
      ...
      subroutine clean_sd_t_d2_6(h3d,h2d,h1d,p6d,p5d,p4d,p7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,p7d
      integer h3,h2,h1,p6,p5,p4,p7
     ...
     1  -t2sub(p7,p4,h1,h2)*v2sub(p7,h3,p6,p5)
      ...
      subroutine clean_sd_t_d2_7(h3d,h2d,h1d,p6d,p5d,p4d,p7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,p7d
      integer h3,h2,h1,p6,p5,p4,p7
     ...
     1  -t2sub(p7,p4,h1,h2)*v2sub(p7,h3,p6,p5)
      ...
      subroutine clean_sd_t_d2_8(h3d,h2d,h1d,p6d,p5d,p4d,p7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,p7d
      integer h3,h2,h1,p6,p5,p4,p7
     ...
     1  -t2sub(p7,p4,h1,h2)*v2sub(p7,h3,p6,p5)
      ...
      subroutine clean_sd_t_d2_9(h3d,h2d,h1d,p6d,p5d,p4d,p7d,
     2                     triplesx,t2sub,v2sub)
      IMPLICIT NONE
      integer h3d,h2d,h1d,p6d,p5d,p4d,p7d
      integer h3,h2,h1,p6,p5,p4,p7
